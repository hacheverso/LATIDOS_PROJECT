    ...
    return (
        <form action={action} className="space-y-4">
            ...
            <button
                type="submit"
                disabled={!isValid}
                className="w-full py-4 bg-card hover:bg-slate-800 disabled:bg-slate-200 dark:bg-white/10 disabled:text-slate-400 disabled:cursor-not-allowed text-white font-bold rounded-xl shadow-lg transition-all active:scale-95 mt-4"
            >
                Confirmar Cuenta
            </button>
        </form>
