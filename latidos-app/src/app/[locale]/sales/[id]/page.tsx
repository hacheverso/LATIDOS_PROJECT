                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-secondary font-medium">
                            {new Date(sale.date).toLocaleDateString("en-US")} • {new Date(sale.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                        </p>
                    </div>
                </div>
                        ...
                        <div className="relative z-10">
                            ...
                            {balance > 0 && (
                                <div className="text-xs font-medium text-orange-600/70 dark:text-orange-400/80 bg-orange-50 dark:bg-orange-500/10 px-3 py-1 rounded-full inline-block">
                                    Vence: {new Date(new Date(sale.date).setDate(new Date(sale.date).getDate() + 30)).toLocaleDateString("en-US")}
                                </div>
                            )}
                            {balance <= 0 && (
                                ...
                                <div key={payment.id} className="p-4 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors flex justify-between items-center group">
                                    <div>
                                        ...
                                        <div className="text-xs text-muted font-medium mt-0.5">
                                            {new Date(payment.date).toLocaleDateString("en-US")} • {new Date(payment.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} • {payment.method}
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
