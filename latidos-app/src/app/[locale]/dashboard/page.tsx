    ...
    try {
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
                ...
                <h2 className="text-xl font-bold text-primary">{t("error_title")}</h2>
        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted font-medium mt-1">{t("holistic_vision")} &bull; {new Date().toLocaleDateString("en-US", { weekday: 'long', day: 'numeric', month: 'long' })}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <QuickActionButton
                    ...
                    icon={PackagePlus}
                    label={t("receive_merchandise")}
                    color="bg-purple-600"
                />
                <QuickActionButton
                    href="/logistics"
                    icon={Truck}
                    label={t("manage_routes")}
                    color="bg-amber-500"
                />
                <QuickActionButton
