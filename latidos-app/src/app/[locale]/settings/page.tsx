...
import { Save, Building2, Smartphone, Mail, Globe, Heading, FileText, Image as ImageIcon, Eye, EyeOff, AlertTriangle, Copy, RefreshCw, Clock, DollarSign, Languages } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-header dark:bg-[#0B0D0F] p-8 space-y-8 transition-colors">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-heading text-primary tracking-tight transition-colors">{t('title')}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-background rounded-2xl p-8 shadow-sm border border-border space-y-6 transition-colors">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-xs font-black text-muted uppercase tracking-widest mb-2 transition-colors">Nombre del Negocio</label>
                            <div className="relative">
                                <Heading className="absolute left-4 top-1/2 -translate-y-1/2 text-muted w-5 h-5 transition-colors" />
                                <input
                                    name="name"
                                    value={formData.name}
                        ...
                        <div>
                            <label className="block text-xs font-black text-muted uppercase tracking-widest mb-2 transition-colors">NIT / Documento</label>
                            <div className="relative">
                                <FileText className="absolute left-4 top-1/2 -translate-y-1/2 text-muted w-5 h-5 transition-colors" />
                                <input
                                    name="nit"
                                    value={formData.nit}
                                    onChange={handleChange}
                        ...
                        <div>
                            <label className="block text-xs font-black text-muted uppercase tracking-widest mb-2 transition-colors">Dirección</label>
                            <div className="relative">
                                <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 text-muted w-5 h-5 transition-colors" />
                                <input
                                    name="address"
                        ...
                        <div className="pt-4 border-t border-border">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`flex-1 py-3 rounded-xl font-black text-sm uppercase tracking-widest border-2 transition-all ${
                                        currentLocale === "en"
                                            ? "bg-slate-800 dark:bg-slate-200 border-slate-800 dark:border-slate-200 text-white dark:text-slate-900 shadow-lg"
                                            : "border-border bg-card text-muted hover:border-slate-300 hover:text-slate-600 dark:hover:text-slate-300"
                                    }`}
                                >
                                    🇺🇸 {t('english')}
                                </button>
                ...
                <div className="space-y-8">
                    <div className="bg-background rounded-2xl p-8 shadow-sm border border-border space-y-6 transition-colors">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-black text-muted uppercase tracking-widest mb-2 transition-colors">Teléfono / WhatsApp</label>
                                <div className="relative">
                                    <Smartphone className="absolute left-4 top-1/2 -translate-y-1/2 text-muted w-5 h-5 transition-colors" />
                                    <input
                                        name="phone"
                            ...
                            <div>
                                <label className="block text-xs font-black text-muted uppercase tracking-widest mb-2 transition-colors">Email</label>
                                <div className="relative">
                                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-muted w-5 h-5 transition-colors" />
                                    <input
                                        name="email"
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="flex items-start gap-6">
                                    <div className="w-32 h-32 bg-header rounded-2xl border-2 border-dashed border-border dark:border-border/20 flex items-center justify-center overflow-hidden relative group transition-colors">
                                        {formData.logoUrl ? (
                                            <>
                                    ...
                                    <div className="flex-1">
                                        <div className="relative">
                                            ...
                                            <p className="text-xs text-muted mt-2 transition-colors">
                            ...
                            <div>
                                <label className="block text-xs font-black text-muted uppercase tracking-widest mb-2 transition-colors">Mensaje al Pie de Página</label>
                                <textarea
                                    name="footerMsg"
                                    rows={3}
                        ...
                        <div className="bg-header dark:bg-[#131517] p-6 rounded-2xl border border-border transition-colors">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="p-3 bg-background border border-border rounded-xl hover:text-red-600 dark:hover:text-red-400 hover:border-red-200 dark:hover:border-red-900/50 hover:bg-red-50 dark:hover:bg-red-500/10 text-muted transition-colors shadow-sm shrink-0"
                                    title="Regenerar Key"
                                >
