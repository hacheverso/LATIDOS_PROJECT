...
export default async function AcceptInvitePage({ searchParams }: { searchParams: { token: string } }) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-header p-4">
            <div className="bg-card p-8 rounded-3xl shadow-xl max-w-md w-full space-y-6 animate-in fade-in zoom-in-95 duration-300">
                <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 bg-card rounded-2xl flex items-center justify-center shadow-xl shadow-slate-900/20 mb-6 rotate-3">
