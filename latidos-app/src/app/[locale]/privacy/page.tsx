export default function PrivacyPage() {
    return (
        <div className="min-h-screen bg-card p-8 md:p-16 max-w-4xl mx-auto font-sans text-primary">
            <h1 className="text-heading mb-6">Política de Privacidad</h1>
            <p className="mb-4">
                <strong>Última actualización:</strong> {new Date().toLocaleDateString("en-US")}
            </p>
            ...
            <section className="border-t pt-8 text-sm text-secondary">
                <p>
                    Latidos - ERP System.
                </p>
            </section>
