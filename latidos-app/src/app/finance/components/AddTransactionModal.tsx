...
export function AddTransactionModal({ isOpen, onClose, type }: AddTransactionModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        const val = parseFloat(amount.replace(/\./g, '').replace(/,/g, '.')); // Basic sanitization for COP logic if needed or just use number input
        // Actually simplest is just regex digit extraction for COP integers
