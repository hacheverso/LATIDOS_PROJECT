...
export default function ReconciliationDashboard({ recentCustomers = [], metrics }: ReconciliationDashboardProps) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Recent Clients */}
            <div>
                <h3 className="text-sm font-bold text-muted uppercase tracking-widest mb-4 transition-colors">Clientes Recientes con Saldo</h3>

                {recentCustomers.length === 0 ? (
                    <div className="bg-background p-8 rounded-2xl border border-border text-center text-muted italic transition-colors">
