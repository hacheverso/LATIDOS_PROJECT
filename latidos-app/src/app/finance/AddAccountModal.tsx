                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    ...
                                    className={`p-6 rounded-2xl border-2 flex flex-col items-center justify-center gap-3 transition-all h-40 ${type === 'CASH' ? 'border-emerald-500 bg-emerald-50 text-emerald-600 ring-2 ring-emerald-500/20' : 'border-slate-100 bg-card text-slate-400 hover:border-slate-200 hover:bg-slate-50'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-6 rounded-2xl border-2 flex flex-col items-center justify-center gap-3 transition-all h-40 ${type === 'BANK' ? 'border-blue-500 bg-blue-50 text-blue-600 ring-2 ring-blue-500/20' : 'border-slate-100 bg-card text-slate-400 hover:border-slate-200 hover:bg-slate-50'}`}
                                >
