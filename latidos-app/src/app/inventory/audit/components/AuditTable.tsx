            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-card p-4 rounded-xl shadow-sm border border-border">
                <div className="relative w-full md:w-96">
                    ...
                    <Input
                        ...
                        className="pl-9 bg-slate-50 dark:bg-white/5 border-border text-primary"
                        value={search}
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        <thead className="bg-background border-b border-border">
                            <tr>
                                <th className="px-4 py-3 text-left font-bold text-muted">Producto</th>
                                <th className="px-4 py-3 text-center font-bold text-muted w-24">UPC</th>
                                <th className="px-4 py-3 text-center font-bold text-muted w-28">Sistema</th>
                                <th className="px-4 py-3 text-center font-bold text-muted w-32">Físico</th>
                                <th className="px-4 py-3 text-center font-bold text-muted w-28">Diferencia</th>
                                <th className="px-4 py-3 text-left font-bold text-muted">Observaciones</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                            {groupedProducts.map(([category, products]) => (
                                <Fragment key={category}>
                                    {/* Category Header */}
                                    <tr className="bg-slate-100 dark:bg-white/5/80 dark:bg-white/5 border-y border-border">
                                            ...
                                            >
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-white/5 border border-border flex items-center justify-center shrink-0 overflow-hidden relative">
                                                            {product.imageUrl ? (
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    {product.upc && (
                                                        <span className="font-mono text-[10px] text-muted bg-slate-100 dark:bg-white/5 px-2 py-1 rounded">
                                                            {product.upc}
                                                        </span>
                                                    )}
                                                </td>
                                                <td className="px-4 py-3 text-center">
                                                    <span className="inline-flex items-center justify-center h-8 px-3 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-slate-300 font-bold font-mono">
                                                        {product.systemStock}
                                                    </span>
                                                </td>
                                                <td className="px-4 py-3 text-center">
