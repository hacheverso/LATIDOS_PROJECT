...
export default function AuditTable({ initialProducts }: AuditTableProps) {
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-card p-4 rounded-xl shadow-sm border border-border">
                <div className="relative w-full md:w-96">
                    ...
                    <Input
                        ...
                        className="pl-9 bg-header border-border text-primary"
                        value={search}
                                ...
                                <Fragment key={category}>
                                    ...
                                    <tr className="bg-header/80 dark:bg-card border-y border-border">
                                        <td colSpan={6} className="px-4 py-2 font-black text-muted uppercase text-xs tracking-wider">
                                            {category} <span className="text-secondary font-normal">({products.length})</span>
                                        </td>
                                    </tr>
  ...
  isMatched ? "bg-green-50/50 dark:bg-emerald-500/10 hover:bg-green-100/50 dark:hover:bg-emerald-500/10 " :
                                            ...
                                            >
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-lg bg-header border border-border flex items-center justify-center shrink-0 overflow-hidden relative">
                                                            {product.imageUrl ? (
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    {product.upc && (
                                                        <span className="font-mono text-[10px] text-muted bg-header px-2 py-1 rounded">
                                                            {product.upc}
                                                        </span>
                                                    )}
                                                </td>
  ...
  diff === 0 ? "bg-green-100 dark:bg-emerald-500/10 text-green-700 dark:text-emerald-300" :
