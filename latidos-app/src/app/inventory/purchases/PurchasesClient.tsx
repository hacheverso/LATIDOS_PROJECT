        ...
        <div className="w-full px-6 mx-auto space-y-12">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
                <div className="flex items-center gap-4">
                    <Link href="/inventory" className="p-2 rounded-full hover:bg-hover /10 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
                ...
                {filteredPurchases.length === 0 ? (
                    ...
                    filteredPurchases.map((purchase: PurchaseWithRelations) => (
                        <div key={purchase.id} className={`p-4 lg:px-6 lg:py-4 rounded-2xl border transition-all grid grid-cols-1 lg:grid-cols-[1.5fr_1fr_2fr_1fr_1.5fr_1fr] gap-4 lg:gap-6 items-center ${purchase.status === 'DRAFT'
                            ...
                            {/* Col 3: Registry */}
                            <div className="flex flex-col">
                                <div className="flex items-center gap-2 text-xs font-mono text-primary0">
                            ...
                            <div className="flex items-center justify-end gap-2 border-t lg:border-t-0 border-border pt-3 lg:pt-0 mt-2 lg:mt-0 w-full lg:w-auto">
                                <button
                                    ...
                                    className="p-2 rounded-lg bg-slate-50 dark:bg-card/5 text-muted hover:bg-hover /10 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                    title="Ver Detalle"
                                >
                        ...
                        <div className="bg-card dark:bg-[#131517] rounded-3xl shadow-2xl w-full max-w-4xl flex flex-col max-h-[85vh] animate-in slide-in-from-bottom-8 duration-300 border border-border">
                            ...
                            <div className="shrink-0 bg-slate-50/80 dark:bg-card/80 backdrop-blur-md border-b border-border p-6 flex justify-between items-start rounded-t-3xl z-10">
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-full hover:bg-slate-200 /10 text-muted hover:text-slate-600 dark:hover:text-slate-300 transition-colors"
                                >
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 bg-card/95 dark:bg-[#131517]/95 backdrop-blur z-0 py-2">
                                        ...
                                        <div className="relative group w-full md:w-64">
                                            <input
                                                ...
                                                className="w-full pl-9 pr-4 py-2 bg-slate-50 dark:bg-card/5 border-border rounded-xl text-xs font-bold text-slate-700  focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-500/20 focus:border-blue-400 transition-all placeholder:text-slate-400 dark:placeholder:text-primary0"
                                            />
                                                                        ...
                                                                        <td className="px-6 py-4">
                                                                            <div className="flex items-center gap-3">
                                                                                <button
                                                                                    ...
                                                                                    className="p-1 rounded-full hover:bg-slate-200 /10 transition-colors shrink-0"
                                                                                >
                                                                                    {isExpanded ?
                                                                                        <ChevronDown className="w-4 h-4 text-transfer dark:text-blue-400" /> :
                                                                                        <ChevronRight className="w-4 h-4 text-slate-300 dark:text-primary0 group-hover:text-primary0 dark:group-hover:text-slate-300" />
                                                                                    }
                                                                                </button>
                            ...
                            <div className="shrink-0 bg-slate-50 dark:bg-card border-t border-border p-4 md:p-6 rounded-b-3xl flex flex-col md:flex-row md:items-center justify-between gap-4 z-10">
                                ...
                                <div className="flex items-center gap-2 order-1 md:order-2 justify-end w-full md:w-auto">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-slate-100 dark:bg-card/10 hover:bg-slate-200 /20 text-slate-700 dark:text-slate-300 rounded-xl font-bold uppercase text-xs flex items-center gap-2 transition-colors shadow-sm border border-border"
