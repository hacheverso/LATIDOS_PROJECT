                        ...
                        <div className="border-2 border-dashed border-slate-300 rounded-2xl p-8 text-center hover:bg-slate-100/50 transition-colors bg-white">
                            ...
                            <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center">
                                ...
                                {file ? (
                                    ...
                                    <>
                                        <span className="text-slate-700 font-bold mb-1 text-lg">Haz clic para buscar tu archivo</span>
                                        <span className="text-slate-500 text-sm">o arrástralo y suéltalo aquí (.csv, .tsv)</span>
                                    </>
                                )}
                            </label>
                        </div>
