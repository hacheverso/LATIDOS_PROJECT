        ...
        <div className="space-y-8 animate-in fade-in duration-500 min-h-screen bg-slate-50/50 p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {customers.map((customer) => (
                    <div key={customer.id} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg transition-all group relative overflow-hidden">
