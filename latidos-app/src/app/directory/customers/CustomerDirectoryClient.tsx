            ...
            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="bg-card dark:bg-card hover:bg-slate-800 dark:hover:bg-hover text-white dark:text-primary text-sm font-medium py-2.5 px-5 rounded-xl transition-colors flex items-center gap-2 shadow-lg shadow-slate-900/10 dark:shadow-none"
                    >
