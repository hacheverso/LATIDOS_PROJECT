...
export function PaymentSummary({ appliedPayments, totalAmount, remainingCredit }: PaymentSummaryProps) {
    return (
        <div className="bg-card text-white rounded-xl p-6 shadow-xl">
            ...
            {remainingCredit > 0 && (
                <div className="bg-brand text-inverse/10 border border-emerald-500/20 rounded-lg p-4 flex items-center gap-3">
