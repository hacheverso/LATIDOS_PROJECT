...
export default function SalesTable({ initialSales }: SalesTableProps) {
  ...
  className="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-500/10 text-success dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-500/10 rounded-xl text-xs font-bold uppercase transition-colors whitespace-nowrap"
            ...
            {selectedIds.length > 0 && (
                <div className="fixed bottom-20 md:bottom-8 left-1/2 -translate-x-1/2 z-50 bg-card backdrop-blur-md text-white pl-6 pr-2 py-2 rounded-2xl shadow-2xl flex items-center gap-6 animate-in slide-in-from-bottom-10 fade-in duration-300 w-[90%] md:w-auto border border-border/10 ring-1 ring-black/50">
