    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100/50 dark:from-[#0B0D0F] dark:to-[#131517] p-8 space-y-8 transition-colors">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                ...
                <Link
                    href="/sales/new"
                    className="flex items-center gap-2 bg-card dark:bg-card text-white dark:text-primary px-5 py-3 rounded-xl font-bold uppercase tracking-wide hover:bg-slate-800 dark:hover:bg-slate-200 dark:bg-card/10 transition-all shadow-lg hover:shadow-xl hover:scale-105"
                >
