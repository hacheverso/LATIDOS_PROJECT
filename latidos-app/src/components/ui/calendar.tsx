        ...
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    ...
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-slate-300 text-slate-700"
                ),
                ...
                head_row: "flex",
                head_cell:
                    "text-slate-900 rounded-md w-9 font-black text-[0.8rem] capitalize text-center",
