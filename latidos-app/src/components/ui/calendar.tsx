    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                button_next: cn(
                    buttonVariants({ variant: "outline" }),
                    "absolute right-1 top-1 h-7 w-7 bg-transparent p-0 opacity-100 hover:opacity-100 border border-slate-300 text-slate-700 shadow-sm"
                ),
                month_grid: "w-full border-collapse space-y-1",
                weekdays: "flex w-full mt-2 justify-between",
                weekday:
                    "text-slate-900 rounded-md w-9 font-bold text-[0.8rem] uppercase text-center",
