        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
            <div className="bg-card rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden border border-border">
                ...
                <div className="p-8 space-y-6">
                    {!result ? (
                        <>
                            <label className="border-2 border-dashed border-border rounded-2xl p-8 flex flex-col items-center justify-center gap-4 hover:border-blue-500 hover:bg-blue-50/30 transition-all group cursor-pointer relative block w-full overflow-hidden">
                                <input
                                    type="file"
                                    ...
                                    <div className="flex flex-col items-center gap-4 py-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-primary text-sm font-medium mt-2 max-w-xs mx-auto">
                                                {result.message || (
                                                    <span>Se han cargado <span className="font-bold text-primary">{result.count}</span> unidades al sistema.</span>
                                                )}
                                            </p>
                                        </div>
                                    </div>
