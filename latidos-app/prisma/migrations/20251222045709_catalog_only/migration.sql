...
INSERT INTO "new_products" ("category", "createdAt", "id", "imageUrl", "name", "sku", "upc", "updatedAt") SELECT "category", "createdAt", "id", "imageUrl", "name", "sku", "upc", "updatedAt" FROM "products";
DROP TABLE "products";
