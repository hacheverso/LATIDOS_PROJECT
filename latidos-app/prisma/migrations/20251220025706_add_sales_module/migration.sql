...
INSERT INTO "new_instances" ("condition", "cost", "createdAt", "id", "imei", "location", "productId", "purchaseId", "serialNumber", "status", "updatedAt") SELECT "condition", "cost", "createdAt", "id", "imei", "location", "productId", "purchaseId", "serialNumber", "status", "updatedAt" FROM "instances";
